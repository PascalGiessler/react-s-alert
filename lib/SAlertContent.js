...
class SAlertContent extends React.Component {
    ...
    render() {
        const classNames = `${this.props.customClassName ? this.props.customClassName : ''} s-alert-box s-alert-${this.props.condition} s-alert-${this.props.position} ${this.props.effect ? `s-alert-is-effect s-alert-effect-${this.props.effect}` : ''} s-alert-show`;
